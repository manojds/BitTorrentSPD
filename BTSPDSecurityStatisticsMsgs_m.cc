...
const char * BTSPDVulnerabilityStatus::moduleType() const
{
    return moduleType_var.c_str();
}

void BTSPDVulnerabilityStatus::setModuleType(const char * moduleType)
{
...
int BTSPDVulnerabilityStatusDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='v' && strcmp(fieldName, "vulnerabilityFixed")==0) return base+1;
...
std::string BTSPDVulnerabilityStatusDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return bool2string(pp->vulnerabilityFixed());
        default: return "";
    }
}
...
bool BTSPDVulnerabilityStatusDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setVulnerabilityFixed(string2bool(value)); return true;
